...
const FounderCard = () => {
  return (
    ...
    <div className="bg-gray-50 py-12 flex justify-center "> {/* Added background color and padding for the entire section */}
    <div className="flex justify-center py-16 px-4"> {/* Added a wrapper div for centering just this card */}
        <div className="relative w-full max-w-sm lg:max-w-md bg-white rounded-3xl shadow-xl overflow-hidden p-4 font-inter"> {/* Added font-inter here */}
