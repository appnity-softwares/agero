...
const Navbar = () => {
  return (
    <header className="bg-[#f3f3f3] relative">
      ...
      {/* Navbar Main */}
      <nav className="max-w-7xl mx-auto flex justify-between items-center px-10 py-8">
        {/* Logo Image */}
        ...
        {/* Nav Links */}
        <ul className="hidden md:flex gap-14 text-gray-700 font-medium tracking-wide">
        ...
        {/* Contact Button */}
        <button className="bg-[#555] text-white px-6 py-2.5 rounded-full shadow-md hover:bg-black transition-transform transform hover:scale-105 duration-200">
          Contact
        </button>
      </nav>
    </header>
